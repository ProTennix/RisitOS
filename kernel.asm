; RisitOS / based on mikeOS / BSD Licence
	...
	%DEFINE MIKEOS_VER '0.2 '	; OS version number
...
option_screen:
	...
	dialog_string_1		db 'RisitOS 0.2 ' , 0
	dialog_string_2		db 'OK pour lancer le terminal' , 0
	dialog_string_3		db '', 0
